...
namespace TylerCode.SoundSystem
{
    ...
    public class S4SoundSource : MonoBehaviour
    {
        ...
        public void PlaySoundWithSetPitch(string name, float spitch = 1f, Vector3? overridePosition = null)
        {
            SoundPlayerSettings _soundPlayerSettings = _sounds.FirstOrDefault(sp => sp.soundName == name);
            ...
            _soundPlayerSettings.setPitch = true;
            _soundPlayerSettings.pitch = spitch;
